# CONTEXT
Lydoria’s citizenship administration is a central Directorate of Citizenship and Integration (DCI), a large public-sector body with a strong tradition of administrative law and formal procedures (equality before the law, proportionality, right to an individualized assessment, etc.). The DCI is under the Ministry of the Interior, but operates with a high degree of technical autonomy in day-to-day operations.

In Lydoria, social dialogue is mandatory. The administration must consult recognized trade unions (TU) on major organizational changes. However, in practice, consultation often comes late, after key technical and contractual choices have already been made, and TU have limited co-decision power.

The AI project was initiated at central administration level and under a digital transformation / modernization agenda. Moreover, the central administration promises that this AI will consistently reduce bias and enhance the effective and fast delivery of public service (fast, fair, f .. ? future, focus, factual). The caseworkers are civil servants with a permanent status, organized into a hierarchical structure of regional and central offices. They are responsible for reviewing applications, verifying legal conditions (residence, criminal record, language, integration, etc.), conducting any necessary checks, and drafting legally sound decisions with detailed justifications.
...
- Development: designed and developed by an external AI contractor and integrated /maintained in collaboration with the internal IT department, which is responsible for data flows and system stability.
...
Our concerns as a Trade Union are the following:
...
- Time needed to verify system’s outputs : Since it is an AI system, its outputs will need to be reviewed by caseworkers, therefore more time is needed for the processing. 
...
- Training : we are concerned that AI will be imposed without proper training.
